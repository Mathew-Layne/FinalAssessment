<div>
    ...
    <div x-data="setup()" :class="{ 'dark': isDark }">
        <div
            ...
            <div class="fixed w-full flex items-center justify-between h-14 text-white z-10">
                <div
                    ...
                    <img class="w-7 h-7 md:w-10 md:h-10 mr-2 rounded-full overflow-hidden"
                        src="{{ Auth::user()->avatar ? Auth::user()->avatar : 'https://therminic2018.eu/wp-content/uploads/2018/07/dummy-avatar.jpg' }}" />
                    ...
                    <ul class="flex flex-col py-4 space-y-1">
                        ...
                        <li>
                            <a href="{{ route('admin.vehicle') }}"
                                ...
                                <span class="ml-2 text-sm tracking-wide truncate">Vehicles</span>
                        ...
                        <li>
                            <a href="{{ route('token') }}"
                                ...
                                <span class="ml-2 text-sm tracking-wide truncate">API Token</span>
                            </a>
                        </li>
                    </ul>
            ...
            <div class="h-full pt-10 px-5 ml-14 mt-14 mb-10 md:ml-64 ">
