          ...
          <div class="w-full h-100">
            ...
            <form class="mt-6" action="{{ route('login') }}" method="POST">
              ...
              <div>
                ...
                <input type="email" name="email" :value="old('email')" placeholder="Enter Email Address" class="w-full px-4 py-3 rounded-lg bg-gray-200 mt-2 border focus:border-blue-500 focus:bg-white focus:outline-none" autofocus autocomplete required>
              </div>
