        ...
        <div class="-mx-2 md:flex w-full md:w-5/6 md:justify-center">
                ...
                <div class="rounded-lg shadow-sm mb-4">
                    <div class="rounded-lg bg-gray-900 shadow-lg md:shadow-xl relative overflow-hidden">
                        <div class="px-3 pt-8 pb-10 text-center relative z-10">
                            <h4 class="text-sm uppercase text-gray-100 leading-tight">Approved Booking</h4>
                            <h3 class="text-3xl text-gray-300 font-semibold leading-tight my-3">{{ $approved }}</h3>
            ...
            <div class="w-full md:w-1/3 px-2">
                <div class="rounded-lg shadow-sm mb-4">
                    <div class="rounded-lg bg-gray-900 shadow-lg md:shadow-xl relative overflow-hidden">
                        <div class="px-3 pt-8 pb-10 text-center relative z-10">
                            <h4 class="text-sm uppercase text-gray-100 leading-tight">Denied Booking</h4>
                            <h3 class="text-3xl text-gray-300 font-semibold leading-tight my-3">{{ $denied }}</h3>
            ...
            <div class="w-full md:w-1/3 px-2">
                <div class="rounded-lg shadow-sm mb-4">
                    <div class="rounded-lg bg-gray-900 shadow-lg md:shadow-xl relative overflow-hidden">
                        <div class="px-3 pt-8 pb-10 text-center relative z-10">
                            <h4 class="text-sm uppercase text-gray-100 leading-tight">Pending Booking</h4>
                            <h3 class="text-3xl text-gray-300 font-semibold leading-tight my-3">{{ $pending }}</h3>
    ...
    <div>
        <div class="mt-10 mx-4">
            <div class="md:col-span-2 xl:col-span-3 mb-3 flex justify-between mx-3">
                <h3 class="text-2xl font-semibold">Approved Reservations</h3>
                <a class="underline hover:text-green-600" href="{{ route('user.reservation') }}">View Details</a>
            </div>
